...
const Sidebar = () => {
    ...
    return (
        <div className="flex">
            ...
            {/* Sidebar */}
            <div
                className={`bg-gray-900 text-white h-screen p-5 pt-8 ${isOpen ? 'w-64' : 'lg:left-0 -left-16 w-0'} lg:w-64 fixed lg:relative z-40 lg:z-auto transition-all duration-500 ease-in-out`}
            >
